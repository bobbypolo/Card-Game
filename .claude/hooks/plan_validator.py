...
_DONE_WHEN_R_ID_RE = re.compile(r"^-\s*(R-P\d+-\d{2}(?:-AC\d+)?):")
...
# Regex to strip leading R-PN-NN: prefix from a criterion string.
_CRITERION_PREFIX_RE = re.compile(r"^R-P\d+-\d{2}(?:-AC\d+)?:\s*")
